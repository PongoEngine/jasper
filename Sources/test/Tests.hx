...
class Tests 
{
    ...
    public static function lessThanEqualTo_ConstantVariableTest() : Void
    {
        ...
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 110, EPSILON, "lessThanEqualTo_ConstantVariableTest() PASSED");
    }
    ...
    public static function greaterThanEqualTo_ConstantVariableTest() : Void 
    {
        ...
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 90, EPSILON, "greaterThanEqualTo_ConstantVariableTest() PASSED");
    }
    ...
    public static function lessThanEqualTo_ExpressionVariableTest() : Void 
    {
        ...
        solver.addConstraint((x == 110));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 110, EPSILON, "lessThanEqualTo_ExpressionVariableTest() PASSED");
    }
    ...
    public static function greaterThanEqualTo_ExpressionVariableTest() : Void
    {
        ...
        solver.addConstraint((x == 90));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 90, EPSILON, "greaterThanEqualTo_ExpressionVariableTest() PASSED");
    }
    ...
    public static function lessThanEqualTo_VariableConstantTest() : Void 
    {
        ...
        solver.addConstraint((x == 90));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 90, EPSILON, "lessThanEqualTo_VariableConstantTest() PASSED");
    }
    ...
    public static function greaterThanEqualTo_VariableConstantTest() : Void 
    {
        ...
        solver.addConstraint((x == 110));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 110, EPSILON, "greaterThanEqualTo_VariableConstantTest() PASSED");
    }
    ...
    public static function lessThanEqualTo_VariableExpression() : Void 
    {
        ...
        solver.addConstraint((x == 90));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 90, EPSILON, "lessThanEqualTo_VariableExpression() PASSED");
    }
    ...
    public static function greaterThanEqualTo_VariableExpression() : Void 
    {
        ...
        solver.addConstraint((x == 110));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 110, EPSILON, "greaterThanEqualTo_VariableExpression() PASSED");
    }
    ...
    public static function lessThanEqualTo_VariableVariableTest() : Void 
    {
        ...
        solver.addConstraint((x == 90));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 90, EPSILON, "lessThanEqualTo_VariableVariableTest() PASSED");
    }
    ...
    public static function greaterThanEqualTo_VariableVariableTest() : Void 
    {
        ...
        solver.addConstraint((x == 110));
        solver.updateVariables();
        Assert.lessThanDelta(x.m_value, 110, EPSILON, "greaterThanEqualTo_VariableVariableTest() PASSED");
    }
    ...
    public static function addRemoveConstraint() : Void 
    {
        var solver = new Solver();
